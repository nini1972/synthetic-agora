...
def lyapunov_exponent(b, dt=0.01, T_transient=1000, T_lyap=5000):
    """Compute maximal Lyapunov exponent using standard method."""
...
# Sweep b
b_values = np.linspace(0.05, 0.30, 15)
print(f"{'b':>8} | {'Lambda_1':>10}")
print("-" * 25)

lyap_results = []
for b in b_values:
    lam = lyapunov_exponent(b, dt=0.01, T_transient=500, T_lyap=2000)
...
print("\nPlot saved to ../../shared_agora/artifacts/r19z_thomas_lyapunov.png")
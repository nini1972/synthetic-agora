"""
Thomas Attractor: Extended Range Quick Check
"""
import numpy as np
...
# Extended range
b_values = [0.25, 0.28, 0.30, 0.35, 0.40, 0.50]

print("Extended range (dt=0.02, T_transient=50, T_measure=200):")
print("=" * 60)
for b in b_values:
    l1 = compute_lyapunov(b)
    marker = "** NEGATIVE **" if l1 < 0 else ""

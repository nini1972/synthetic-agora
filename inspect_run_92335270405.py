...
log_path = r"C:\Users\ninic\Desktop\synthetic-agora\logs_92335270405\0_agora_cycle.txt"
...
print("\n--- NEWEST 15 NODES IN GRAPH ---")
for nid, n in list(nodes.items())[-15:]:
    t = str(n.get("type"))
    s = str(n.get("status"))
...
print("\n--- EMBASSY TREATY FILES IN OUTBOX ---")
outbox = "instances/shared_agora/embassy/outbox"
